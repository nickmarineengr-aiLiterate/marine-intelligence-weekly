...
Nine branches. Own these and you can construct an answer to most of the 142
mapped questions.
...
| # | ID | Question |
|---|---|---|
| 1 | `QB3_B#q9` | Overview of the classification society survey system — types, periodicity, role of class |
| 2 | `QB3_B#q1` | What is a hull survey — coverage and requirements |
| 3 | `QB3_B#q11` | After a Renewal survey, what do subsequent Annual and Intermediate surveys require |
| 4 | `QB3_B#q5` | Full overview of the ESP Code — scope, ship types, cycles |
| 5 | `QB3_B#q4` | Definition of 'substantial corrosion' and the criteria |
| 6 | `QB3_B#q2` | Criteria for steel plate renewal during a hull survey |
| 7 | `QB3_B#q8` | The full drydocking process — intervals and inspections |
| 8 | `QB1_supplementary#q4` | CMS scope — what the CE may survey, what class must, what is *not* covered |
| 9 | `QB1_supplementary#q5` | Load Line Survey preparation — CE engine room responsibilities |
| 10 | `QB1_supplementary#q8` | SAFCON survey — what the surveyor checks in the engine room |
| 11 | `QB1_supplementary#q20` | Tail Shaft Survey — what, when due, full procedure |
| 12 | `QB1_H#q3` | IACS UR vs PR vs UI — differentiate |
| 13 | `QB1_K#q2` | Condition of Class — who issues it, and when |
| 14 | `QB1_I#q5` | Explain any renewal survey in detail as Chief Engineer *(no examiner evidence; included as the integrating question)* |

**B-priority (12)** — `QB1_F#q13` (audit vs survey vs inspection vs statutory
survey), `QB1_F#q14`, `QB1_F#q15` (CSM credit limits), `QB1_F#q7`, `QB1_F#q8`,
`QB1_G#q31` (in-water survey conditions), `QB1_G#q36` (class quarterly
...
> **Adjudication notes.** `QB10_B#q8` (recent Indian circulars) is Indian
> regulatory currency, not statutory-framework theory — held at C and flagged
> for D06 when an oral Indian-law mapping exists. `QB1_supplementary#q6`/`#q7`
> are MARPOL certification items reached through the survey route; legitimate
> here, kept at C so they are studied as survey preparation, not as MARPOL.
...
| 7. Certificate set | **PARTIAL** | asked *per certificate*; no single question makes you assemble the whole set |
| 8. Hull condition & drydock | **STRONG** | orals + 2 written families |
| 9. Port State Control | **STRONG** | 8 written occurrences |

**Gaps to close yourself (note requirements):**

- **N1 — the consolidated certificate table.** Instrument → certificate →
  issuer → validity → endorsement → survey that supports it. Nothing in the
  corpus builds this in one place, and every survey answer leans on it.
  *Highest-value note in this topic.*
...
Written QP2412-Q4 and QP2511-Q5. Build **N2** (survey timeline) as you go.

**Session 3 — Hull condition & drydock (60–75 min)**
Orals 5, 6, 7, 11 (`QB3_B#q4`, `#q2`, `#q8`, `QB1_supplementary#q20`).
Written QP2503-Q2 and QP2507-Q7. Build **N5** (corrosion numbers).

**Session 4 — Certificates, flag & PSC (75–90 min)**
Orals 9, 10, 13, 14. Written QP2504-Q2 and QP2606-Q2 (PSC), QP2401-Q9 (III
Code). Build **N1** (certificate table) and **N4** (PSC chain).

**Session 5 — Follow-ups & closed-book mock (60 min)**
B-priority orals, especially `QB1_F#q13` and `QB1_F#q15`. Build **N3**. Then
