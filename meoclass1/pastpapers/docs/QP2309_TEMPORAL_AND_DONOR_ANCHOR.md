...
**INTEGRATED (status corrected in laptop review: QP2312 and QP2304 were published to main on 2026-08-14, so this donor is no longer pending Founder review)** in the map below. No claim in this paper rests on an unintegrated paper alone.
...
rest is fresh. `QP2312-Q2` is the nearest in time (+3 months, same year) and is **INTEGRATED (status corrected in laptop review: QP2312 and QP2304 were published to main on 2026-08-14, so this donor is no longer pending Founder review)**;
...
### 3.4 SIX-YEAR WORDING ANCESTRY — added in laptop review, 2026-08-14

**This section did not exist when the paper was authored, and could not have.** The 2021–2022 and
unsolved-2023 intelligence layer (`meoclass1/pastpapers/intelligence/historical_qp_intelligence.json`,
30 sittings / 270 questions) was generated at 12:01 IST on 2026-08-14; this branch was pushed at 07:25.
The donor map in §3 was therefore derived against 279 solved questions. It has now been re-derived
against **549** — the solved corpus plus the intelligence layer.

**The distinction that governs this section.** The intelligence layer carries *printed question wording
and nothing else*. There is no model answer, no Understand, no route and no verified claim anywhere in
it. So it can correct **where a question was first asked**. It can never supply **what the answer is**.
Nothing below changes a single `reused_from`, `reuse_tier` or `reuse_evidence` value, and no answer-law
claim on this paper rests on any intelligence-only sitting.

| Q | Earliest known appearance — §3 | Earliest known appearance — corrected | Direction |
|---|---|---|---|
| **Q1** | QP2407-Q1, July 2024 | **this sitting — the family has no earlier member** | originates |
| **Q2** | QP2401-Q5(b), January 2024 | **QP2207-Q7, July 2022** (via QP2208-Q5 Aug 2022, QP2303-Q8(b) Mar 2023) | **BACKWARD** |
| Q3 | QP2402-Q5, February 2024 | QP2101-Q6, January 2021 | backward |
| **Q4** | QP2402-Q1, February 2024 | **QP2102-Q2, February 2021** (repeated QP2109-Q2, September 2021) | **BACKWARD** |
| Q5 | no donor | **no donor — re-tested and confirmed** | — |
| Q6 | no donor | **no donor — re-tested and confirmed** | — |
| Q7 | QP2404-Q8, April 2024 | this sitting — no earlier member of this task | originates |
| Q8 | QP2404-Q9, April 2024 | QP2101-Q2, January 2021 | backward |
| Q9 | QP2312-Q2, December 2023 | this sitting — no earlier member of *this* task | originates |

**The two findings that matter.**

1. **Q2's wording ancestry runs backward, and §3.3 must be read accordingly.** `QP2303-Q8(b)`
   (March 2023) prints this paper's entire sixteen-mark stem word for word **six months before the
   sitting**, and the family runs back to July 2022. §3.3's heading *"every donor is later"* remains
   true — it is a statement about **answer donors**, and every one of those is still later — but it is
   **not** true of lineage, and a reader who took it as a statement about the question's history would
   be wrong. QP2303 is an unsolved sitting, so it donates wording and nothing else.

2. **Q4 roots in February 2021, three years earlier than recorded.** `QP2102-Q2` and `QP2109-Q2` print
   limb (a) verbatim. Both attach a different second limb — the two amendment procedures, not the
   Convention/Protocol/Code/Resolution hierarchy — so the paper-level relation is NEAR and the
   limb-level relation is EXACT. `QP2109` is **September 2021, the same calendar month exactly two
   years before this sitting.**

**The two "fresh research" findings were re-tested and both survive**, which is the result worth
recording because it was the one most likely to break. Q5's only six-year hits are `QP2207-Q4` and
`QP2211-Q1`, which match on *"fine grain"* in an Impressed Current Cathodic Protection question, and
`QP2306-Q8(b)`, a cargo-claim question that mentions a grain cargo. Q6 has no hit at all; the nearest,
`QP2206-Q2(d)` (June 2022), asks about initial and periodic *survey* with respect to Load Lines and is
RELATED_ONLY. **Grain stability and conditions of assignment are genuinely absent from six years of
sittings** — tested now against 549 questions rather than 279.
