...
| C | 24 | 18 | Derived: no family member has a built answer. New research. |
| D | **3** | **9** | Derived: the family contains at least one question whose answer is built and verified. |
...
Stored Tier D over the unsolved set counts **1**; derived counts **12**. Planning off the stored field would have under-counted ready work by 11 question(s) and would have sent a solving session to research answers that already have a verified donor.
...
| Risk class | Count |
|---|---|
| IMO INSTRUMENT IN FLUX | 5 |
| INDIAN STATUTE BOUNDARY | 3 |
| GUIDELINE EDITION | 2 |
| CONVENTION NOT YET IN FORCE | 1 |
