...
Amended 17 Sep 2026 after independent review: direct action stated jurisdiction-
neutrally (India's Bunkers Convention status is a separate queued audit);
response responsibility stated by location rather than 'the Coast Guard leads';
Tier 2/3 as escalation beyond local capability rather than 'ICG declares'; and a
speakable Q15 60-second answer.
"""
...
Q15_REGION = """        <div class="answer-body">
          ...
          <p>Who responds depends on where the spill occurs (above); whoever responds, the cost is recovered from the polluter. Liability rests on the <strong>shipowner</strong> — strict, but normally <strong>within the convention limits</strong> and subject to the convention defences. The <strong>P&amp;I club is the liability insurer, not the liable party</strong>; where the applicable liability convention provides for direct action (for example CLC 1992), a claim may also be brought <strong>directly against the insurer</strong>. Persistent oil from tankers: <strong>CLC 1992</strong> (owner) with the <strong>1992 Fund</strong> on top. Bunker oil from other ships: the separate bunker-spill regime (see Q4). The CE's record of every response action, time and resource supports the claim.</p>
          <h4>Reporting</h4>
        ...
        <div class="oral-box oral-60"><span class="oral-label">60-Second Answer</span>NOSDCP, the National Oil Spill Disaster Contingency Plan, is India's national plan under OPRC 1990 and sits under the Ministry of Defence. The Indian Coast Guard is the Central Coordinating Authority; the DG Coast Guard chairs it. Who responds depends on location: the Coast Guard in the maritime zones, ports within port limits, oil-handling agencies within 500 m of their installations, coastal States on the shoreline. Tier 1 is local resources, Tier 2 regional Coast Guard response, Tier 3 national mobilisation with international help. The polluter pays: the shipowner is liable, normally within convention limits, and the P&amp;I club insures that liability.</div>
        <div class="reg-box">
...
Q14_EDITS = [
    ...
    ("<li><strong>Polluter Pays Principle:</strong> ICG mobilises response but holds the registered shipowner (through P&amp;I club) strictly liable for ALL costs of containment, clean-up, and environmental restoration. CE must document every response action, time, and resource — this record forms the basis of cost recovery claims</li>",
     "<li><strong>Polluter Pays Principle:</strong> whoever responds — the port within port limits, the Indian Coast Guard in the maritime zones — the cost is recovered from the polluter. The <strong>shipowner</strong> is liable — strictly, but normally within the convention limits and subject to the convention defences; the <strong>P&amp;I club insures that liability</strong>, and where the applicable liability convention provides for direct action (for example CLC 1992), a claim may also be brought directly against the insurer. CLC 1992 with the 1992 Fund covers persistent oil from tankers; bunker spills from other ships fall under the separate bunker regime (Q4). CE must document every response action, time, and resource — this record supports cost recovery claims</li>"),
    ...
    ("while India's NOSDCP implements this nationally with the Indian Coast Guard leading three-tier spill response in Indian waters.",
     "while India's NOSDCP implements this nationally, with the Indian Coast Guard as Central Coordinating Authority for a three-tier spill response."),
    ...
    ("ship activates SOPEP, ICG declares Tier 2 or Tier 3 NOSDCP response, and all costs are later recovered from the shipowner's P&amp;I club.",
     "ship activates SOPEP; if the incident exceeds local capability, the response escalates to Tier 2 or Tier 3 under NOSDCP, with the Coast Guard taking the coordinating/overall response role; response costs are later claimed from the shipowner and its P&amp;I insurer, within the applicable liability limits."),
