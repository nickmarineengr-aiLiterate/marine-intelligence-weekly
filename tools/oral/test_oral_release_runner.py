...
check("the correction gates are registered",
      ...
      == ["correction_annexvi_eif_mutate", "correction_bulkjupiter_mutate",
          ...
          "validate_correction_india_oilspill",
...
POST_E6_GATES = [
    ...
    # The two 2026-09-08 Bulk Jupiter corrections, found in final release
    # qualification. Both cards were already pinned and both pins were green
    # over wrong content: a digest cannot see that the wrong body was named
    # as the investigator, that a qualified finding was stated as a
    # conclusion, or that a duration was wrong by a factor of four.
    "correction_bulkjupiter_mutate",
    ...
    # CORR-INDIA-OILSPILL-REGULATORY-AUDIT-20260917: four India oil-spill
    # propositions queued by the NOSDCP record, each gated as a proposition.
    "correction_india_oilspill_mutate",
    "correction_ismspares_mutate",
    # CORR-ITC51-20260908, found in final release qualification. The
    # cleanest case in this list for why a per-correction CONTENT gate is
    # not optional: the Pass-2 gate watching these six cards asked whether
    # they named ITC-Hulls, and all fourteen defective sites said yes. The
    # instrument was right and the clause inside it was wrong.
