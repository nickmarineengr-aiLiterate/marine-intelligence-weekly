...
drifted apart without anything noticing. This is that script, promoted to a
governed tool with its inputs and outputs named.
...
def build(source_glob=SOURCE_GLOB):
    ...
    return {
        ...
        'regenerate_with': 'python tools/pastpapers/extract_historical_qp.py',
